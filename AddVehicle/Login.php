...
<head>
  ...
  <div class="form" style="margin-top:35px;" id="first_form">
    ...
    <form class="login-form" action="Login.php" method="post">
      ...
      <button style="margin-bottom:10px;" id="sign" name="add" >Add vehicle</button>
	  <br>
...
if (isset($_POST['add'])){ 
	...
	$sql = "INSERT INTO vehicle(Type, EngineVol, Brand, YearOfProd, CarID, ClientID) 
	VALUES('$type ',$engine,'$brand','$year', '$carid', '$clientid')";
